 ...
 */
public class ComparadorMarcaModeloTest {
    ...
    Coche coche4 = new Coche(5678, "Tesla", "A",10000, 6000, 500, 80);
    /**
     * Test of compare method, of class ComparadorMarcaModelo.
     */
    @Test
    public void testCompare() {
        System.out.println("compare");
        ComparadorMarcaModelo comp = new ComparadorMarcaModelo();
        assertTrue(comp.compare(coche1,coche2) < 0);
        assertTrue(comp.compare(coche2,coche3) == 0 );
        assertTrue(comp.compare(coche4,coche2) < 0);  
    }
